...
// Find the start of stage 4
const startIdx = content.indexOf('function startStage4CanvasGame');
// Find the Start Application part
const endIdx = content.indexOf('// --- Start Application ---');
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    fs.writeFileSync('public/safety_gate.html', before + stage4Code + after, 'utf8');
