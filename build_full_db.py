...
# Programmatic builder for 50+ molecules across 10 groups
def build_all():
    db = []
    ...
    db.append({
        ...
        "applications": "Khí thiên nhiên, Biogas, nhiên liệu sạch, nguyên liệu sản xuất phân đạm ure.",
        "atoms": [
    ...
    db.append({
        ...
        "reactions": "Thế clo, dehydro hóa thành ethylene.",
        "applications": "Nguyên liệu cracking sản xuất etilen – monomer nhựa PE.",
        "atoms": [
    ...
    db.append({
        ...
        "solubility": "Không tan trong nước",
        "reactions": "Cháy tỏa nhiệt lớn, thế halogen ưu tiên C bậc 2.",
        "applications": "Thành phần chính khí đốt LPG / Gas gia đình.",
        "atoms": [
    ...
    # Save
    with open("molecules_data.json", "w", encoding="utf-8") as f:
        json.dump(db, f, ensure_ascii=False, indent=2)
    print("Molecules JSON saved:", len(db))
